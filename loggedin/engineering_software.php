...
<div class="java-container">
  ...
  <div class="card" >
      <img src="production.jpg" class="card-img-top" alt="..." >
      <div class="card-body">
        <p class="card-text" >Production 1</p>

        <p class="card-text details">Language : frensh</p>
  ...
  <div class="card" >
      <img src="production.jpg" class="card-img-top" alt="..." >
      <div class="card-body">
        <p class="card-text" >Production 2</p>
