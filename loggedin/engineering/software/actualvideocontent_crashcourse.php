 ...
 <body>
  ...
  <?php
      ...
      if (isset($_GET['video'])){
        switch ($_GET['video']) {
          case '0':
            $lien="https://www.youtube.com/embed/watch?v=5nUjGNDImIk";
            $nom_vid="1 step pour la production  ";
            $chapitre="0";
            break;
          case '1':
                ...
                case '0':
                  ...
                  <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="actualvideocontent_crashcourse.php?video=0">&#10170  Quizzes</a><br>
                      </div>
                    </div>
                  </div>';
                  break;
